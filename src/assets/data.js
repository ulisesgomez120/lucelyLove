  ...
  testimonials: {
    ...
    reviews: [
      ...
      },
      {
        name: "Zaira",
        excerpt:
          "They have even told me that I look much brighter than before.",
        review:
    ...
    packages: [
      {
        ...
        description: "Receive 4, 30 minute coaching sessions within a month",
        price: "$125",
      ...
      {
        name: "2 video calls in a month",
        description: "Receive 2, 45 minute coaching sessions within a month",
        price: "$220",
...
export const spanishData = {
  ...
  service: {
    ...
    packages: [
      {
        name: "Sesion de 1 mes",
        description: "Reciba 4 sesiónes de 30 minutos en un mes",
        price: "$125",
